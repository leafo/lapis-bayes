...
local zero_width_character = P("\205\143") + P("\194\173") + P("\216\156") + P("\225\160\142") + P("\226\128") * (R("\139\143") + R("\170\174")) + P("\226\129") * (R("\160\164") + R("\166\175")) + P("\239\184") * R("\128\143") + P("\239\187\191") + P("\243\160") * R("\128\129") * R("\128\191") + P("\243\160") * (R("\132\134") * R("\128\191") + P("\135") * R("\128\175"))
local strip_zero_width_pattern = Cs((zero_width_character / "" + P(1)) ^ 0)
